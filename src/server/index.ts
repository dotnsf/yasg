import { ServerConfig, MessageType, ConnectionState } from '../shared/types';
...
export class GatewayServer {
   ...
   */
  private handleTcpConnection(socket: any, connectionId: string): void {
   ...
   */
  private handleConnectSuccess(connectionId: string): void {
   ...
   */
  private handleConnectError(connectionId: string, error?: string): void {
